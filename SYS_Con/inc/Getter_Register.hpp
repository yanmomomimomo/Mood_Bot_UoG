...
class CameraGetter : public GetterEventDriven {
    public:
        CameraGetter(Camera_class &camera, EventBus &bus, const std::string &topic);
        virtual ~CameraGetter(){};
